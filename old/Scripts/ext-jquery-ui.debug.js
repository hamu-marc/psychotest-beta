/*! Ben's jQuery UI Extensions - v1.1.1 - 2015-10-09
...
* Copyright 2015 Ben Olson; Licensed MIT */
(function( $ ) {
    ...
    $.widget( "ui.labeledslider", $.ui.slider, {
      ...
      _drawLabels: function () {
         ...
         var labels = this.options.tickLabels || {},
             ...
             stp = this.options.step, //fix of step <1 e.g. 0.5
             cnt = ( max - min ),
         ...
         for (;i<=cnt;i+=stp) { //fix of step <1, prevent overstep the labels
            ...
            if ( ( !ta && i%inr == 0 ) || ( ta && tickArray.indexOf( i+min ) > -1 ) ) {
               ...
               $('<div>').addClass( 'ui-slider-label-ticks' )
                   .css( dir, (Math.round( ( i / cnt ) * 10000 ) / 100) + '%' ) //round( x/stp)*stp => rounds to stp precision
